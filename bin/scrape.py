...
# Authenticated source modules (e.g., SSO-gated boards) are intentionally not
# included in this public substrate — implement them in your private deployment.
...
def main() -> None:
    ...
    ap.add_argument("--source", required=True,
                    choices=["remoteok", "wwr", "builtin", "generic"])
    ap.add_argument("--limit", type=int, default=None)
    ap.add_argument("--urls", type=Path, default=None,
                    help="Path to file with URLs (for builtin/generic sources)")
